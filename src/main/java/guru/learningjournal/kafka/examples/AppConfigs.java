...
public class AppConfigs {
    ...
    public final static String sysIdentTopicName = "system_identifier";

    public final static String corpEntityTopicName = "corporate_entity";
    public final static String corpTopicName = "corporate_consolidated";
    public final static String entityIdentTopicName = "entity_identifier";
